...
const scheduleTimeController = require("../controllers/scheduleTimeController");

// Define routes
router.post("/addschedule", scheduleTimeController.addSchedule);
router.get("/allscheduleDetails", scheduleTimeController.getAllSchedules);
router.put("/updateschedule/:scheduleId", scheduleTimeController.updateSchedule);
router.delete("/deleteschedule/:scheduleId", scheduleTimeController.deleteSchedule);
router.post("/confirm", scheduleTimeController.confirmSchedule);
